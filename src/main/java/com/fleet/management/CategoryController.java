...
public class CategoryController {
	...
	public ResponseEntity<Category> updateCategory(@PathVariable(value = "id") Long categoryId, @Valid @RequestBody Category newCategory)
		...
		Category oldCategory = repo.findById(categoryId).orElseThrow(() -> new Exception("Category " + categoryId + " not found"));
	...
	public void updateCategory(@PathVariable(value = "id") Long categoryId) throws Exception {
		Category category = repo.findById(categoryId).orElseThrow(() -> new Exception("Category " + categoryId + " not found"));
